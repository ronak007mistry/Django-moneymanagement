from .views import RegistrationView,RequestpasswordResetEmail, CompletePasswordReset, UsernameValidationView, EmailValidationView, LogoutView, VerificationView, LoginView
